            ...
            <div class="row">
                ...
                %> 
                  ...
                  <div class="card design" style="width: 100%;">
                     ...
                     <div class="card-body">
                         <center><h6 class="card-title">Name: <%= candids.get(i).getFirstname() %> </h6>
                             <h5 class="card-text">Party</h5>
                             <h4 class="card-text">ID: <%= candids.get(i).getCandidateid() %></h4>
                         <button class="btn delete-btn "  onclick="process('<%= candids.get(i).getCandidateid() %>','president')">Delete</button>
...
//                             
//           function process(e,userId, candID, position){
//                                 alert("PR");
//            
//        $.ajax({
//            type: "POST",
            ...
            <div class="row">
                ...
                %>
                        ...
                        <div class="card design" style="width: 100%;">
                           ...
                           <div class="card-body">
                               <center><h6 class="card-title">NAME: <%= secretary.get(i).getFirstname() %> </h6>
                                   <h5 class="card-text">PARTY</h5>
                                   <h4 class="card-text">ID: <%= secretary.get(i).getCandidateid() %> </h4>
                                <a class="btn btn-info" href="javascript:{}" onclick="manageUser(this.id, <%= candids.get(i).getCandidateid() %>)" id="delete">Delete</a>
...
<!--    <script>
        ...
        function process(e, canId,positn){
          alert("nice 1");
        $.ajax({
            type:"POST",
            url:"ajax",
