      ...
      <div class="container-fluid top-margin pb-3">
        <div class="row">
         ...
         <div class="col-lg-8 bg-gray">
             <form id="" action="Router" method="POST">
                  <div id="form1" >
                      <h5 class="text-success">${info}</h5>
                      <div class="form-group"> 
                        <input type="file" name="image" onchange="readURL(this);" class="form-control-file" id="imagefile">
                      </div>
                        <div class="form-row top-margin ">
                          <div class="form-group col-md-6">
                            <input type="text" name="f_name" class="form-control" id="f_name" placeholder="Enter FirstName">
                          </div>
                          <div class="form-group col-md-6">
                            <input type="text" name="l_name" class="form-control" id="l_name" placeholder="Enter lastName">
                          </div>
                        </div>
                        <div class="form-row ">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">D.O.B</label>
                                <input type="date" name="date" class="form-control" id="dob" placeholder="D.O.B">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row ">
                            <div class="form-group col-md-7">
                                <input type="email" name="email" class="form-control" id="email" placeholder="Email Adress">
                            </div>
                        ...
                        <div class="form-group">
                          <input type="text" class="form-control"name="home_address" id="home_address" placeholder="Home Adress">
                        </div>
                        <div class="form-row">
                          <div class="form-group col-md-6">
                 ...
                 <button type="submit" class="btn btn-info">Submit</button>
                  <input type="text" name="signal" value="submit" hidden>
